...
class TestWhiteBox(unittest.TestCase):
    ...
    def test_create_user_role_not_found(self, mock_connect):
        ...
        result = create_user('testuser', 'test@example.com', 'password', 'nonexistent_role')
    ...
    def test_detection_manager_round_robin(self, MockWorker):
        ...
        # FIX: Use the correct method name 'submit' instead of 'submit_frame'
        manager.submit('frame1', 'cam1')
        manager.submit('frame2', 'cam2')
        manager.submit('frame3', 'cam3')
        manager.submit('frame4', 'cam4')  # This should wrap back to worker 0
        ...
        # FIX: Use the correct attribute name 'next_worker_index'
        self.assertEqual(manager.next_worker_index, 1)  # Should be at position 1 after 4 submissions
