...
classif_model = YOLO(os.path.join("yolo_models", "yolo11n-cls.pt"))
...
if __name__ == "__main__":
    ...
    try:
        ...
        # food model preprocess
        inference_food_thread = threading.Thread(
            target=preprocess,
            args=(food_model, pose_model, food_class_list, 0.3, classif_model),
            daemon=True,
        )
